...
public class DEMO1 extends javax.swing.JFrame {
    ...
    public DEMO1() {
        initComponents();
        String[] nume = {"Ana","Dan","Ion"};
//        l.setListData(nume);
        DefaultListModel m = new DefaultListModel();
        for (int i = 0; i < nume.length; i++) {
            String string = nume[i];
            m.addElement(string);
        }
        l.setModel(m);
    }
    ...
    private void initComponents() {
        ...
        l.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "xxxxxxxxxx", "yyyyyyyyyyyyy" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        l.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
